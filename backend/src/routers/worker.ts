...
import { Connection, Keypair, PublicKey, SystemProgram, Transaction, TransactionError, sendAndConfirmTransaction } from "@solana/web3.js";
...
router.post("/signin", async(req, res) => {
    ...
    const message = new TextEncoder().encode("Sign into mechanical labelify as a worker");
